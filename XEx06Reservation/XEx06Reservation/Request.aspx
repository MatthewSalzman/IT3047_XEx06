        ...
        <main>
            <form id="form1" runat="server" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- text box -->
                        <asp:TextBox ID="txtDepartureData" runat="server" TextMode="Date"
                             CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- drop-down -->
                        <asp:DropDownList ID="ddlNumPeople" runat="server">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 bedtype">
                        <!-- radio buttons -->
                        <asp:RadioButtonList ID="rdoBedSize" runat="server" Height="16px" Width="1270px">
                            <asp:ListItem>King</asp:ListItem>
                            <asp:ListItem Value="TwoQueens">Two Queens</asp:ListItem>
                            <asp:ListItem Value="OneQueen">One Queen</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-7">
                        <!-- multiline text box -->
                        <asp:TextBox ID="txtSpecialRequests" runat="server" Rows="4" TextMode="MultiLine" Width="484px"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- drop down -->
                        <asp:DropDownList ID="ddlPreferedMethod" runat="server">
